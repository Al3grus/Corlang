...
.section-head.mid{justify-content:center;text-align:center}
...
(function(){
  ...
  var emailBox = document.getElementById('invite-email-box');
  ...
  /* One place decides what is on screen, so the states cannot drift apart: nothing chosen is
     just the question, either answer opens the same form, and iPhone adds the line about there
     being no build yet.
...
{body}
  <dialog id="invite">
    <form class="dlg" method="dialog">
      ...
      <p>Leave your email and you will get a test link when the next round opens. Nothing
      ...
      <p id="invite-ios" hidden>Corlang is an Android app today, and there is no iPhone
      version yet. Leave your address anyway and you will be the first to hear if that
      changes.</p>
      <div id="invite-email-box" hidden>
  ...
  <section class="hero">
    <div class="hero-copy">
      ...
      <!-- The GOAL first. It used to close the hero, under two paragraphs of method, which sold
           ...
           to believe the promise, so it follows the promise.
           Styled exactly like the other two on purpose: position carries the emphasis here, and
           an earlier attempt at giving it extra weight and full ink changed how the headline
           above read against it. -->
  ...
  <section class="section">
    ...
    <div class="faq">
      ...
      <details name="faq">
        ...
        about you is ever sold. Exactly one thing ever leaves your phone, and only if you use it:
        the AI tutor. It sends what you type, the name you picked at setup, and roughly which
        words the course has taught you so far, so the tutor can reply using words you already
        know. Your progress, your streak and your review schedule never leave the device, and
        there is no Corlang account to store them in. The
        <a href="/privacy/">privacy policy</a> has the detail.</p>
      </details>
    </div>
  </section>
