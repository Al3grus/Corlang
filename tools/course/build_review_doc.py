...
function INTRO(){
  ...
  '</table>'+
  '<p>Whichever you pick, a box opens underneath. <b>Please write what it should say instead.</b> '+
  'A correction we can paste in is worth ten flags without one.</p>'+
  ...
  '<p>Anything that is not about one specific item — gaps, progression, a lesson that misses the '+
  'point — goes on the <b>Overall notes</b> page.</p>'+
