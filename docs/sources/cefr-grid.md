...
- **URLs:** https://www.coe.int/en/web/common-european-framework-reference-languages/table-2-cefr-3.3-common-reference-levels-self-assessment-grid ·
  https://europass.europa.eu/en/common-european-framework-reference-language-skills
- **Fetched:** 2026-07-09
- **Role:** `levels.json` `skills` arrays quote these descriptors verbatim (English). The ASOO
  curriculum's Croatian descriptors (see `asoo-curriculum.md`) are the same framework.
