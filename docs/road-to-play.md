...
- **App access**: **"All or some functionality is restricted."** Not the no-login answer —
  ...
  > Installing gives immediate access to the whole of level A0 in both courses, ten lessons
  > each, together with their vocabulary reviews, exercises and progress
